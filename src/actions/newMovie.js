...
export function onNewMovieSubmit({ title, category, country, cover, year, imdb, director_id }){
	return dispatch => {
		dispatch({
			type: "NEW_MOVIE",
...
export function onUpdateMovieSubmit({ _id, title, category, country, year, imdb, cover, director_id }){
	return dispatch => {
		dispatch({
			type: "NEW_MOVIE",
